...
export default function RandomizedTest() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="fixed top-0 left-0 right-0 bg-white py-2 shadow-md">
        <div className="max-w-7xl mx-auto px-8 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <button 
              className="text-gray-600 hover:text-gray-900 relative group focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-0 border-0"
            ...
            <h1 className="text-xl font-bold text-black">TN MRB - Pharmacist - Mock Test</h1>
          </div>
          <div className="flex items-center gap-4">
            ...
            {!submitted ? (
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className={`bg-blue-600 text-white px-6 py-2 rounded-lg shadow transition-colors ${!selectedAnswers.some(answer => answer !== null) ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-700'}`}
                >
                  Submit Test
                </button>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-8 pt-20 text-black">
        <div className="flex gap-4">
          ...
          <div className="fixed left-8 top-20 w-[160px] bg-white rounded-xl shadow-md p-4">
          ...
          {/* Questions Container */}
          <div className="flex-1 bg-white rounded-xl shadow-md p-4 ml-[176px]">
